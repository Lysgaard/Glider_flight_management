...
<ul class="nav nav-pills">
  <li role="presentation"><a href="#" onClick="show_flight('flight_date','ASC')">Show Flight Information</a></li>
  <li role="presentation"><a href="#" onClick="show_preflight()" >Show Pre Flight Information</a></li>
